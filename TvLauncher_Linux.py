    ...
    def save_config(self):
        ...
        with open(self.config_file, 'w') as f:
            json.dump({
                ...
                'show_clock': self.config_data.get('show_clock', True),  # ✅ NUOVO
                'auto_download': self.config_data.get('auto_download', True),  # ✅ NUOVO
                'sound_effects': self.config_data.get('sound_effects', False),  # ✅ NUOVO
                'fullscreen': self.config_data.get('fullscreen', True),  # ✅ NUOVO
            }, f, indent=2)
