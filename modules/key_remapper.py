...
class KeyCaptureDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.setModal(True)
        self.setFixedSize(self.scaling.scale(500), self.scaling.scale(300))
        ...
        # Titolo
        title = QLabel(f"🎮 Remap Action: {self.action_name}")
        ...
        self.instruction_label.setStyleSheet("font-size: 16px; color: white;")
