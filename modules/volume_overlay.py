...
class GlobalVolumeManager(QObject):
    """
    ✅ SEMPLIFICATO: Non ha più polling proprio
    Viene chiamato dal JoystickManager quando necessario
    """
    ...
    def __init__(self, scaling, launcher_window=None):
        ...
        print("🔊 GlobalVolumeManager initialized (no polling)")
...
def install_volume_control(scaling, launcher_window):
    """
    ✅ SEMPLIFICATO: Installa solo il controller e l'overlay
    ...
    """
    if not VOLUME_AVAILABLE:
        print("⚠️ Volume control: audio backend non disponibile")
        return None
    
    volume_manager = GlobalVolumeManager(scaling, launcher_window)
    print("✅ Volume manager created (controlled by JoystickManager)")
