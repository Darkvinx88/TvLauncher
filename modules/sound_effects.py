"""
Sound Effects Manager - FIXED FOR LINUX
Gestisce la riproduzione dei suoni di navigazione
"""
...
class SoundManager:
    ...
    ✅ FIX: Risolve il problema dei suoni che si silenziano su Linux
    """
    ...
    def __init__(self, enabled=False):
        ...
        # ✅ FIX LINUX: Su Linux usa QMediaPlayer invece di QSoundEffect
    ...
    def _init_media_player(self):
        """
        ✅ NUOVO: Inizializza QMediaPlayer per Linux
        ...
        for sound_id, filename in sound_files.items():
            ...
            if sound_path.exists():
                try:
                    ...
                    print(f"✅ Loaded sound (MediaPlayer): {sound_id}")
    ...
    def _play(self, sound_id):
        """
        ✅ FIX: Riproduce un suono con gestione separata per Linux
        """
    ...
    def cleanup(self):
        """
        ✅ NUOVO: Pulizia corretta delle risorse audio
